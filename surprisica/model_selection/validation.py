...
def cross_validate(algo, data, measures=['rmse', 'mae'], cv=None,
    ...
    Args:
        algo(:obj:`AlgoBase \
            <surprisica.prediction_algorithms.algo_base.AlgoBase>`):
            The algorithm to evaluate.
        data(:obj:`Dataset <surprisica.dataset.Dataset>`): The dataset on which
            to evaluate the algorithm.
        measures(list of str): The performance measures to compute. Allowed
...
def fit_and_score(algo, trainset, testset, measures,
    ...
    Args:
        ...
        trainset(:obj:`Trainset <surprisica.trainset.Trainset>`): The trainset.
        testset(:obj:`testset`): The testset.
        measures(list of string): The performance measures to compute. Allowed
            names are function names as defined in the :mod:`accuracy
            <surprisica.accuracy>` module.
        return_train_measures(bool): Whether to compute performance measures on
